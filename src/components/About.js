    ...
    return (
        <div>
            <div className="grid-container">
                ...
                <a className="non resu" href="https://drive.google.com/file/d/1QRSlbR8Yo8WhFcuTkYa0daoyTTsXDYyh/view?usp=sharing" target="_blank" rel="noopener noreferrer" style={{color: '#f40009'}}>resume&#x1F865;</a> 
                </div>
                </div>
                </div>
